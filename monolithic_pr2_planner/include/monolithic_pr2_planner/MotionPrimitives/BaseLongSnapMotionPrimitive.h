...
namespace monolithic_pr2_planner {
  class BaseLongSnapMotionPrimitive : public MotionPrimitive {
    public:
      BaseLongSnapMotionPrimitive():m_tolerances(4,0)
      {
      ...
      virtual int motion_type() const { return MPrim_Types::BASE_LONGSNAP; }; 
  ...
  typedef boost::shared_ptr<BaseLongSnapMotionPrimitive> BaseLongSnapMotionPrimitivePtr;
