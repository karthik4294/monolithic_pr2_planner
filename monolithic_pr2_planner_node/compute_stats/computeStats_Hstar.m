...
for t = 1:5
    ...
    stats_file = ['stats_bitstarfirstsol_' num2str(t-1)];
    ...
    for i = 1:num
        ...
        bitstarfirstsol_path = ['../' stats_file '/paths_bitstarfirstsol_' num2str(i-1)  '/bitstarfirstsol_'];
        ...
        bitstarfirstsol_stats{t}{i} = computeMethodStats(bitstarfirstsol_path,num,0);
...
bitstarfirstsol = normalizeStats(bitstarfirstsol_stats);
...
[bitstarfirstsol_mod, hstar_mod_bitstarfirstsol] = getStatsCommonSucc(bitstarfirstsol, hstar);
...
printStats(bitstarfirstsol_mod, hstar_mod_bitstarfirstsol, 'bitstarfirstsol');
